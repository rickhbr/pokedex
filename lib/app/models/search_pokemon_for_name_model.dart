class SearchPokemonForNameModel {
  SearchPokemonForNameModel({
  ...
  factory SearchPokemonForNameModel.fromJson(Map<String, dynamic> json) {
    return SearchPokemonForNameModel(
  ...
  Map<String, dynamic> toJson() => {
        "abilities": List<Ability>.from(abilities.map((x) => x.toJson())),
        "base_experience": baseExperience,
        "forms": List<Species>.from(forms.map((x) => x.toJson())),
        "game_indices":
            List<GameIndex>.from(gameIndices.map((x) => x.toJson())),
        "height": height,
        "held_items": List<HeldItem>.from(heldItems.map((x) => x.toJson())),
        "id": id,
        "is_default": isDefault,
        "location_area_encounters": locationAreaEncounters,
        "moves": List<Move>.from(moves.map((x) => x.toJson())),
        "name": name,
        "order": order,
        "past_types": List<dynamic>.from(pastTypes.map((x) => x)),
        "species": species?.toJson(),
        "sprites": sprites?.toJson(),
        "stats": List<Stat>.from(stats.map((x) => x.toJson())),
        "types": List<Type>.from(types.map((x) => x.toJson())),
        "weight": weight,
      };
}
...
class HeldItem {
  ...
  Map<String, dynamic> toJson() => {
        "item": item?.toJson(),
        "version_details":
            List<VersionDetail>.from(versionDetails.map((x) => x.toJson())),
      };
}
...
class Move {
  ...
  Map<String, dynamic> toJson() => {
        "move": move?.toJson(),
        "version_group_details": List<VersionGroupDetail>.from(
